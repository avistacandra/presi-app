...
<a href="{{ route('ta/index') }}" class="btn btn-secondary btn-sm">
    << kembali </a>
        <div class="content-wrapper">
            <form action="{{ route('ta/update', $tahunajaran->id) }}" method="post">
                @csrf
                <div class="row">
        ...
        Silahkan Input Kelas
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="status_ta" id="status_ta" value="{{ isset($tahunajaran) ?$tahunajaran->status_ta : ''}}">
                                </div>
                            </div>
