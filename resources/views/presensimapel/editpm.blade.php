...
@section('judul')
FORM EDIT DATA PRESENSI MATA PELAJARAN
@endsection
...
<a href="{{ route('pm/index') }}" class="btn btn-secondary btn-sm">
    << kembali </a>
        <div class="content-wrapper">
            <form action="{{ route('pm/update', $presensimapel->id) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-12 grid-margin stretch-card"">
<div class=" card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Edit Presensi Mata Pelajaran</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <select class="custom-select" name="pertemuan_ke" id="pertemuan_ke" value="{{ isset($presensimapel) ?$presensimapel->pertemuan_ke : ''}}">
