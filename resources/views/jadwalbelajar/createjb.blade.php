...
@section('judul')
FORM TAMBAH DATA JADWAL BELAJAR
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="jam_belajar" type="text" id="jam_belajar" class="form-control" placeholder="00.00 - 00.00" value="{{ Session::get('jam_belajar') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
